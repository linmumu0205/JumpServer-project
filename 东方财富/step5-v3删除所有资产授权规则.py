...
def read_permissions(jms_url, token):
    ...
    response = requests.get(url=jms_url + "/api/v1/perms/asset-permissions/", headers=headers,verify=False)
...
if __name__ == '__main__':
    ...
    token = "3FlriZVH5S47AnJKnzBwXHeI06mPeXbzpI5N"
    for i in range(20):

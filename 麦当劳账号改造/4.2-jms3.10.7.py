        ...
        if permissions:
            ...
            for permission in permissions:
                info = {
                    ...
                    'users_amount': permission['users_amount'],
                    #'asset': permission['assets'],
                    'asset': permission['assets_amount'],
...
def main():
    jms_config = JMSConfig(
        jms_url='http://10.1.12.87/api/v1',
        #token='b525e8305efddeaa807b33e3c58c148889247273',
        token='0527d6b7f9932910c80d4a84fc3eefb082940946',   #3.10.7
        #jms_org='00000000-0000-0000-0000-000000000002',
        jms_org='cf4e17ad-797c-42e2-aba3-b372fb185ddc',     #3.10.7
    )
    excel_file = "accounts_info2.xlsx"

...
correct_excel = './JumpServer-Correct-Asset.xlsx'
...
class Tool(object):
    ...
    def update_asset(self, asset_account):
        ac = {
            ...
            'username': asset_account[7],
            'name': asset_account[7],
            'privileged': True if (asset_account[7] == 'root' or asset_account[7] == 'administrator') else False,
            'secret': asset_account[8]
        }
